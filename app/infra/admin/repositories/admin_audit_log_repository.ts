 ...
 *
 * Infrastructure - Data access for admin audit log operations via MongoDB.
 */
export default class AdminAuditLogRepository {
  ...
  private async buildFilter(params: ListAuditLogsParams): Promise<Record<string, unknown>> {
