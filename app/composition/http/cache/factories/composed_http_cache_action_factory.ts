...
import ListCacheKeysQuery from '#modules/http/actions/cache/queries/list_cache_keys_query'
...
export default class ComposedHttpCacheActionFactory extends HttpCacheActionFactory {
  ...
  makeListCacheKeysQuery(context: HttpActionContext): ListCacheKeysQuery {
    return new ListCacheKeysQuery(context)
  }
}
