import type { AdminCustomSystemRoleRecord } from '#modules/admin/permissions/actions/ports/outbound/admin_custom_system_role_gateway'
...
import { CreateCustomSystemRoleCommand } from '#modules/authorization/actions/commands/create_custom_system_role_command'
import { DeleteCustomSystemRoleCommand } from '#modules/authorization/actions/commands/delete_custom_system_role_command'
import { RefreshCustomSystemRolePermissionCacheCommand } from '#modules/authorization/actions/commands/refresh_custom_system_role_permission_cache_command'
import { UpdateCustomSystemRoleCommand } from '#modules/authorization/actions/commands/update_custom_system_role_command'
import { GetCustomSystemRolePermissionsQuery } from '#modules/authorization/actions/queries/get_custom_system_role_permissions_query'
import { GetCustomSystemRoleQuery } from '#modules/authorization/actions/queries/get_custom_system_role_query'
import { IsCustomSystemRoleCodeTakenQuery } from '#modules/authorization/actions/queries/is_custom_system_role_code_taken_query'
import { IsCustomSystemRoleQuery } from '#modules/authorization/actions/queries/is_custom_system_role_query'
import { ListCustomSystemRolesQuery } from '#modules/authorization/actions/queries/list_custom_system_roles_query'
import { CustomSystemRolePermissionCache } from '#modules/authorization/infra/cache/custom_system_role_permission_cache'
import CustomSystemRoleRepository from '#modules/authorization/infra/repositories/custom_system_role_repository'
import type {
  CustomSystemRoleInput,
  CustomSystemRoleProvider,
} from '#modules/authorization/public_contracts/custom_system_role_api'
