...
} from '#modules/admin/organizations/actions/ports/outbound/organizations/admin_search_candidate_readers'
import {
  AdminUserSearchCandidateReader,
  type AdminUserSearchCandidate,
  type AdminUserSearchCandidatesInput,
} from '#modules/admin/users/actions/ports/outbound/users/admin_search_candidate_readers'
