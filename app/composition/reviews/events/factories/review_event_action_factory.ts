import ProcessDisputeResolvedEventCommand from '#modules/reviews/actions/commands/disputes/process_dispute_resolved_event_command'
...
import ProcessReviewSubmittedEventCommand from '#modules/reviews/actions/commands/review-submission/process_review_submitted_event_command'
...
export class ReviewEventActionFactory {
  ...
  makeProcessReviewConfirmedEventCommand(): ProcessReviewConfirmedEventCommand {
    ...
    return new ProcessReviewConfirmedEventCommand(
      ...
      eventProcessing.accomplishmentProjector
    )
  }
