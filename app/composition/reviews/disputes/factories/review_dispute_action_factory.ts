...
import BuildReviewDisputeCaseFileCommand from '#modules/disputes/actions/commands/build_review_dispute_case_file_command'
import CreateReviewDisputeCommand from '#modules/disputes/actions/commands/create_review_dispute_command'
import CreateReviewDisputeCommentCommand from '#modules/disputes/actions/commands/create_review_dispute_comment_command'
import CreateReviewDisputeEvidenceCommand from '#modules/disputes/actions/commands/create_review_dispute_evidence_command'
...
import ResolveFlaggedReviewCommand from '#modules/moderation/actions/commands/resolve_flagged_review_command'
...
import type { AiProfileAssessmentApprovalUnitOfWork } from '#modules/reviews/actions/ports/outbound/ai_profile_assessment_approval_unit_of_work'
...
import type { ReviewDisputeArtifactReader } from '#modules/disputes/actions/ports/outbound/review_dispute_artifact_reader'
...
import type { ReviewDisputeResolutionUnitOfWork } from '#modules/disputes/actions/ports/outbound/review_dispute_resolution_unit_of_work'
...
import type { ReviewFlaggedModerationUnitOfWork } from '#modules/moderation/actions/ports/outbound/review_flagged_moderation_unit_of_work'
import type { ReviewMetricsReader } from '#modules/reviews/actions/ports/outbound/review_metrics_reader'
import type { ReviewOrgDisputeReader } from '#modules/disputes/actions/ports/outbound/review_org_dispute_reader'
...
import ListReviewDisputeCaseFilesQuery from '#modules/disputes/actions/queries/list_review_dispute_case_files_query'
import ListReviewDisputeCommentsQuery from '#modules/disputes/actions/queries/list_review_dispute_comments_query'
import ListReviewDisputeEvidencesQuery from '#modules/disputes/actions/queries/list_review_dispute_evidences_query'
...
export interface ReviewDisputeActionFactoryDependencies {
  ...
  profileAssessmentApprovals?: AiProfileAssessmentApprovalUnitOfWork
}
...
export class ReviewDisputeActionFactory {
  ...
  makeApproveAiProfileCapabilityProposalCommand(
    execCtx: ReviewActionContext
  ): ApproveAiProfileCapabilityProposalCommand {
    return new ApproveAiProfileCapabilityProposalCommand(
      execCtx,
      this.requireProfileAssessmentApprovals()
    )
  }
  ...
  private requireProfileAssessmentApprovals(): AiProfileAssessmentApprovalUnitOfWork {
    if (!this.dependencies.profileAssessmentApprovals) {
      throw new Error('AI profile assessment approval capability is not configured')
    }
    return this.dependencies.profileAssessmentApprovals
  }
