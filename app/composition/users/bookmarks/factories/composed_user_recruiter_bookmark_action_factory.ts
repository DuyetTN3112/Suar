import CreateRecruiterBookmarkCommand from '#modules/users/actions/commands/bookmarks/create_recruiter_bookmark_command'
import DeleteRecruiterBookmarkByTalentCommand from '#modules/users/actions/commands/bookmarks/delete_recruiter_bookmark_by_talent_command'
import DeleteRecruiterBookmarkCommand from '#modules/users/actions/commands/bookmarks/delete_recruiter_bookmark_command'
import UpdateRecruiterBookmarkCommand from '#modules/users/actions/commands/bookmarks/update_recruiter_bookmark_command'
...
import ListRecruiterBookmarksQuery from '#modules/users/actions/queries/bookmarks/list_recruiter_bookmarks_query'
import ListRecruiterBookmarksWorkspaceQuery from '#modules/users/actions/queries/bookmarks/list_recruiter_bookmarks_workspace_query'
...
export class ComposedUserRecruiterBookmarkActionFactory extends UserRecruiterBookmarkActionFactory {
  ...
  makeList(context: UserActionContext): ListRecruiterBookmarksQuery {
    return new ListRecruiterBookmarksQuery(context, this.bookmarks, this.access)
  }
  ...
  makeDeleteByTalent(context: UserActionContext): DeleteRecruiterBookmarkByTalentCommand {
