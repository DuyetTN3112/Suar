...
import { buildCurrentOrganizationProcessJoinRequestInput } from '#modules/organizations/invitations/controllers/mappers/request/current_organization_mutation_request_mapper'
...
export default class ApproveJoinRequestController {
  ...
  async handle(ctx: HttpContext) {
    ...
    await this.invitationCommands.makeProcessJoinRequest(execCtx).execute(dto)
