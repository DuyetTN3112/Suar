...
import { OrganizationEntity } from '#modules/organizations/directory/domain/entities/organization_entity'
import type { OrganizationEntityProps } from '#modules/organizations/directory/domain/entities/organization_entity'
