...
import { buildCurrentOrganizationRoleUpdateInput } from '#modules/organizations/members/controllers/mappers/request/current_organization_mutation_request_mapper'
...
export default class UpdateMemberRoleController {
  ...
  async handle(ctx: HttpContext) {
    ...
    await this.memberAdministrationCommands
      ...
      .executeFromRequest(roleUpdateInput, { resolveAssignableRoles: true })
