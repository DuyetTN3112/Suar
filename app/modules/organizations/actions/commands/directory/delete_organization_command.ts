 ...
 */
export default class DeleteOrganizationCommand extends BaseCommand<DeleteOrganizationDTO> {
  constructor(
  ...
  async handle(dto: DeleteOrganizationDTO): Promise<void> {
  ...
  async execute(dto: DeleteOrganizationDTO): Promise<void> {
    ...
    const organizationId = await this.organizationTransactionRunner.run(async (trx) => {
      // ── FETCH ──────────────────────────────────────────────────────────
