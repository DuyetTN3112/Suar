...
interface BulkAddMembersOutput {
 ...
 */
export default class BulkAddMembersCommand extends BaseCommand<
  BulkAddMembersDTO,
  BulkAddMembersOutput
> {
  constructor(
    ...
    private readonly organizationTransactionRunner: OrganizationTransactionRunner,
    private readonly memberships: OrganizationMembershipRepository,
    private readonly organizationEventPublisher: OrganizationEventPublisher
  ) {
    super(execCtx, organizationTransactionRunner)
  }

  async handle(dto: BulkAddMembersDTO): Promise<BulkAddMembersOutput> {
    return this.execute(dto)
  }

  async execute(dto: BulkAddMembersDTO): Promise<BulkAddMembersOutput> {
    ...
    const addMember = new AddMemberCommand(
      ...
      this.organizationTransactionRunner,
      this.memberships,
