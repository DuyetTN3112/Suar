...
import { buildCreateCurrentOrganizationProjectDTO } from '#modules/organizations/projects/controllers/mappers/request/current_project_request_mapper'
...
export default class CreateProjectController {
  ...
  async handle(ctx: HttpContext) {
    ...
    const project = await this.actions.make(execCtx).execute(input)
