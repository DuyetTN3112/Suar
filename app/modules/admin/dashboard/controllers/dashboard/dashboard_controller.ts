...
import { buildAdminSubscriptionsRequest } from '#modules/admin/dashboard/controllers/mappers/request/dashboard/admin_dashboard_read_request_mapper'
...
export default class AdminDashboardController {
  ...
  async subscriptions(ctx: HttpContext) {
    ...
    const pagination = buildAdminSubscriptionsRequest(request)
