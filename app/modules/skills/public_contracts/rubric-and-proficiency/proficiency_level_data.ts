import type {
  BroadProficiencyBandDescriptor,
  ExactProficiencyLevelDescriptor,
} from './proficiency_level_constants.js'

export const EXACT_PROFICIENCY_LEVELS: ExactProficiencyLevelDescriptor[] = [
  {
...
export const BROAD_PROFICIENCY_BANDS: BroadProficiencyBandDescriptor[] = [
  {
