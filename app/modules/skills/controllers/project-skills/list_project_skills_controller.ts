    ...
    return {
      data: camelizeResponseValue(
        skills.map((ps) => {
          ...
          if (typeof ps.minimum_task_requirement_level_id === 'string') {
            item['minimum_task_requirement_level_id'] = ps.minimum_task_requirement_level_id
          }
          if (typeof ps.maximum_task_requirement_level_id === 'string') {
            item['maximum_task_requirement_level_id'] = ps.maximum_task_requirement_level_id
          }
          return item
        })
      ),
