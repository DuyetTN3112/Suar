...
import type { ReviewDisputeCaseFileResult } from '#modules/disputes/actions/commands/build_review_dispute_case_file_command'
...
export default class ListReviewDisputeCaseFilesQuery extends BaseQuery<
  ListReviewDisputeCaseFilesDTO,
...
> {
  ...
  async handle(dto: ListReviewDisputeCaseFilesDTO): Promise<ReviewDisputeCaseFileResult[]> {
  ...
  execute(dto: ListReviewDisputeCaseFilesDTO): Promise<ReviewDisputeCaseFileResult[]> {
