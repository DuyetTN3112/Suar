...
export default class ListOrgReviewDisputesQuery extends BaseQuery<
  ListOrgReviewDisputesDTO,
  ListOrgReviewDisputesResult
> {
  constructor(
  ...
  async handle(dto: ListOrgReviewDisputesDTO): Promise<ListOrgReviewDisputesResult> {
  ...
  execute(dto: ListOrgReviewDisputesDTO): Promise<ListOrgReviewDisputesResult> {
