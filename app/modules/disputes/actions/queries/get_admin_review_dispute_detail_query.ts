...
export default class GetAdminReviewDisputeDetailQuery extends BaseQuery<
...
> {
  ...
  async handle(dto: GetAdminReviewDisputeDetailDTO): Promise<GetAdminReviewDisputeDetailResult> {
