...
import { mapReviewDataApiBody } from '#modules/reviews/controllers/mappers/response/review-core/review_response_mapper.js'
...
export default class ShowAdminReviewDisputeController {
  ...
  async handle(ctx: HttpContext) {
    try {
      ...
      console.error('SHOW ADMIN REVIEW DISPUTE CONTROLLER ERROR:', error)
      throw error
    }
  }
}
