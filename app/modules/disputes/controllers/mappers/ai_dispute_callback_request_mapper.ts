...
import type { ProcessAiDisputeCallbackDTO } from '#modules/disputes/actions/commands/process_ai_dispute_callback_command'
...
export function buildAiDisputeCallbackRequest(transport: CallbackTransport): ProcessAiDisputeCallbackDTO {
  ...
  const dto: ProcessAiDisputeCallbackDTO = {
