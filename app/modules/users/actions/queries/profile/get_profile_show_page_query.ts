...
export default class GetProfileShowPageQuery extends BaseQuery<
  GetProfileShowPageInput,
  GetProfileShowPageResult
> {
  constructor(
  ...
  async handle(input: GetProfileShowPageInput): Promise<GetProfileShowPageResult> {
