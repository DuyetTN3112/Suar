...
import { buildGetProfileSnapshotHistoryDTO } from '../mappers/request/profile/user_request_mapper.js'
import { mapProfileSnapshotHistoryApiBody } from '../mappers/response/profile/user_response_mapper.js'
...
export default class GetProfileSnapshotHistoryController {
  ...
  async handle(ctx: HttpContext) {
    ...
    const result = await query
      .executeAndWrap(buildGetProfileSnapshotHistoryDTO(ctx.request, execCtx.userId))
