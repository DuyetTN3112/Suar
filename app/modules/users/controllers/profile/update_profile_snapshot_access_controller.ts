...
import { buildUpdateProfileSnapshotAccessDTO } from '../mappers/request/profile/user_request_mapper.js'
...
export default class UpdateProfileSnapshotAccessController {
  ...
  async handle(ctx: HttpContext) {
    ...
    const result = await command
      .executeAndWrap(buildUpdateProfileSnapshotAccessDTO(request, params['snapshotId'] as string))
