...
export interface GlobalSearchQueryInput {
  ...
  readonly options?: GlobalSearchQueryOptions
}

export class GlobalSearchQuery extends BaseQuery<GlobalSearchQueryInput, GlobalSearchResult> {
  constructor(
  ...
  handle(input: GlobalSearchQueryInput): Promise<GlobalSearchResult>
  handle(rawQuery: string, options?: GlobalSearchQueryOptions): Promise<GlobalSearchResult>
  override async handle(
    inputOrRawQuery: GlobalSearchQueryInput | string,
    legacyOptions: GlobalSearchQueryOptions = {}
  ): Promise<GlobalSearchResult> {
    const rawQuery = typeof inputOrRawQuery === 'string' ? inputOrRawQuery : inputOrRawQuery.rawQuery
    const options = typeof inputOrRawQuery === 'string' ? legacyOptions : inputOrRawQuery.options ?? {}
