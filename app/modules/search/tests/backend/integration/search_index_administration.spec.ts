...
test.group('Integration | Search index administration', (group) => {
  ...
  test('cleans only expired retired generations and rolls back with exact alias fencing', async ({
    ...
    const [
      ...
      import('#modules/search/actions/commands/apply_search_index_cleanup_command'),
      import('#modules/search/actions/commands/apply_search_index_rollback_command'),
      import('#modules/search/actions/queries/preview_search_index_cleanup_query'),
      import('#modules/search/actions/queries/preview_search_index_rollback_query'),
      import('#modules/search/domain/search_index_administration_policy'),
      import('#modules/search/infra/adapters/postgres_search_index_cutover_fence'),
      import('#modules/search/infra/adapters/node_search_index_plan_token_generator'),
      import('#modules/search/infra/search_index_administration_repository'),
      import('#modules/search/infra/versioned_search_index_lifecycle'),
