...
import type {
  ElasticsearchSemanticBinding,
  ElasticsearchSemanticBindings,
} from './elasticsearch_filter_compiler.js'
...
export type ExpressionCompilerFn = (
  expression: FilterExpression,
  bindings: ElasticsearchSemanticBindings,
  now: Date
) => estypes.QueryDslQueryContainer

export function compileKnownPredicate(
  condition: FilterCondition,
  binding: ElasticsearchSemanticBinding,
  now: Date,
  compileExpression: ExpressionCompilerFn
): estypes.QueryDslQueryContainer {
  switch (binding.type) {
    case 'scalar':
    ...
    case 'relation':
      return compileRelation(condition, binding, now, compileExpression)
    case 'boolean':
