...
export class ReviewApplicationMapper {
  ...
  static toSessionResponse(entity: ReviewSessionEntity): ReviewSessionResponseDTO {
    return {
      ...
      creatorReviewerId: entity.creatorReviewerId,
      creatorReviewCompleted: entity.creatorReviewCompleted,
      managerReviewCompleted: entity.managerReviewCompleted,
      managerReviewsCount: entity.managerReviewsCount,
      peerReviewsCount: entity.peerReviewsCount,
      requiredPeerReviews: entity.requiredPeerReviews,
      requiredTotalReviews: entity.requiredTotalReviews,
      minimumManagerReviews: entity.minimumManagerReviews,
      minimumPeerReviews: entity.minimumPeerReviews,
