...
export interface GetSprintReviewDisputeDetailInput {
  disputeId: string
}

export default class GetSprintReviewDisputeDetailQuery extends BaseQuery<
  GetSprintReviewDisputeDetailInput,
  SprintReviewDisputeDetail
> {
  constructor(
  ...
  async execute(disputeId: string): Promise<SprintReviewDisputeDetail> {
    return this.handle({ disputeId })
  }

  async handle({ disputeId }: GetSprintReviewDisputeDetailInput): Promise<SprintReviewDisputeDetail> {
