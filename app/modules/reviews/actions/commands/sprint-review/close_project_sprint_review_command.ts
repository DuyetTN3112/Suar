...
export default class CloseProjectSprintReviewCommand extends BaseCommand<
...
> {
  ...
  async handle(dto: CloseProjectSprintReviewDTO): Promise<CloseProjectSprintReviewResult> {
