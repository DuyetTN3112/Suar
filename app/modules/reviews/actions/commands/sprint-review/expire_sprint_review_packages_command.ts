...
export default class ExpireSprintReviewPackagesCommand extends BaseCommand<
  ExpireSprintReviewPackagesDTO,
  ExpireSprintReviewPackagesResult
> {
  constructor(
  ...
  async handle(dto: ExpireSprintReviewPackagesDTO): Promise<ExpireSprintReviewPackagesResult> {
