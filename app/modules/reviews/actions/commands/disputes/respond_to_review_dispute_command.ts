...
export default class RespondToReviewDisputeCommand extends BaseCommand<
  RespondToReviewDisputeDTO,
  ReviewDisputeResponseResult
> {
  constructor(
  ...
  async handle(dto: RespondToReviewDisputeDTO): Promise<ReviewDisputeResponseResult> {
  ...
  execute(dto: RespondToReviewDisputeDTO): Promise<ReviewDisputeResponseResult> {
