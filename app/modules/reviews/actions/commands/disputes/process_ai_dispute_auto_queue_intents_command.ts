...
export type ProcessAiDisputeAutoQueueIntentsCommandInput =
  | {
  ...
  | {
      ...
      readonly sourceType: AiDisputeSourceType
...
export class ProcessAiDisputeAutoQueueIntentsCommand extends BaseCommand<
  ProcessAiDisputeAutoQueueIntentsCommandInput,
  AiDisputeAutoQueueIntentBatchResult
> {
  ...
  override handle(
    input: ProcessAiDisputeAutoQueueIntentsCommandInput
  ): Promise<AiDisputeAutoQueueIntentBatchResult> {
    if (input.operation === 'batch') {
      return this.executeBatch(input.workerId, input.signal)
    }
    return this.executeSource(input.sourceType, input.sourceId, input.workerId, input.signal)
  }
