...
export default class SaveAiDisputeFeedbackCommand extends BaseCommand<
  SaveAiDisputeFeedbackDTO,
  AiDisputeFeedbackResult
> {
  constructor(
  ...
  async handle(dto: SaveAiDisputeFeedbackDTO): Promise<AiDisputeFeedbackResult> {
