import type ApproveAiProfileCapabilityProposalCommand from '#modules/disputes/actions/commands/approve_ai_profile_capability_proposal_command'
import type BuildReviewDisputeCaseFileCommand from '#modules/disputes/actions/commands/build_review_dispute_case_file_command'
import type CreateReviewDisputeCommand from '#modules/disputes/actions/commands/create_review_dispute_command'
import type CreateReviewDisputeCommentCommand from '#modules/disputes/actions/commands/create_review_dispute_comment_command'
import type CreateReviewDisputeEvidenceCommand from '#modules/disputes/actions/commands/create_review_dispute_evidence_command'
import type CreateSprintReviewDisputeCommand from '#modules/disputes/actions/commands/create_sprint_review_dispute_command'
import type CreateSprintReviewDisputeCommentCommand from '#modules/disputes/actions/commands/create_sprint_review_dispute_comment_command'
import type ProcessAiDisputeCallbackCommand from '#modules/disputes/actions/commands/process_ai_dispute_callback_command'
import type ProcessDisputeResolvedEventCommand from '#modules/disputes/actions/commands/process_dispute_resolved_event_command'
import type ReportReviewDisputeCommand from '#modules/disputes/actions/commands/report_review_dispute_command'
import type ReportSprintReviewDisputeCommand from '#modules/disputes/actions/commands/report_sprint_review_dispute_command'
import type ResolveReviewDisputeCommand from '#modules/disputes/actions/commands/resolve_review_dispute_command'
import type RespondSprintReverseReviewWorkflowCommand from '#modules/disputes/actions/commands/respond_sprint_reverse_review_workflow_command'
import type RespondToReviewDisputeCommand from '#modules/disputes/actions/commands/respond_to_review_dispute_command'
import type SaveAiDisputeFeedbackCommand from '#modules/disputes/actions/commands/save_ai_dispute_feedback_command'
import type StartAiDisputeEvaluationCommand from '#modules/disputes/actions/commands/start_ai_dispute_evaluation_command'
import type ResolveFlaggedReviewCommand from '#modules/moderation/actions/commands/resolve_flagged_review_command'
...
import type GetAdminReviewDisputeDetailQuery from '#modules/disputes/actions/queries/get_admin_review_dispute_detail_query'
import type GetSprintReviewDisputeDetailQuery from '#modules/disputes/actions/queries/get_sprint_review_dispute_detail_query'
import type ListAdminReviewDisputesQuery from '#modules/disputes/actions/queries/list_admin_review_disputes_query'
import type ListAiDisputeEvaluationsQuery from '#modules/disputes/actions/queries/list_ai_dispute_evaluations_query'
import type ListOrgReviewDisputesQuery from '#modules/disputes/actions/queries/list_org_review_disputes_query'
import type ListReviewDisputeCaseFilesQuery from '#modules/disputes/actions/queries/list_review_dispute_case_files_query'
import type ListReviewDisputeCommentsQuery from '#modules/disputes/actions/queries/list_review_dispute_comments_query'
import type ListReviewDisputeEvidencesQuery from '#modules/disputes/actions/queries/list_review_dispute_evidences_query'
