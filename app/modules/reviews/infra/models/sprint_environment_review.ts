...
export default class SprintEnvironmentReview extends BaseModel {
  static override table = 'sprint_environment_reviews'
  ...
  @column()
  declare target_type: 'project' | 'organization'
  ...
  @column()
  declare is_anonymous_publicly: boolean
