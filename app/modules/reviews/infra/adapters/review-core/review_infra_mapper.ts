...
import type SkillReview from '#modules/reviews/infra/models/self-assessment/skill_review'
...
export class ReviewInfraMapper {
  ...
  static toSessionDomain(model: ReviewSession): ReviewSessionEntity {
    const props: ReviewSessionEntityProps = {
      ...
      creatorReviewerId: model.creator_reviewer_id,
      creatorReviewCompleted: model.creator_review_completed,
      managerReviewsCount: model.manager_reviews_count,
      peerReviewsCount: model.peer_reviews_count,
      requiredPeerReviews: model.required_peer_reviews,
      requiredTotalReviews: model.required_total_reviews,
      minimumManagerReviews: model.minimum_manager_reviews,
      minimumPeerReviews: model.minimum_peer_reviews,
  ...
  static toSessionOrm(entity: Partial<ReviewSessionEntityProps>): Record<string, unknown> {
    ...
    if (entity.creatorReviewerId !== undefined) result['creator_reviewer_id'] = entity.creatorReviewerId
    if (entity.creatorReviewCompleted !== undefined)
      result['creator_review_completed'] = entity.creatorReviewCompleted
    if (entity.managerReviewsCount !== undefined)
      result['manager_reviews_count'] = entity.managerReviewsCount
    ...
    if (entity.requiredTotalReviews !== undefined)
      result['required_total_reviews'] = entity.requiredTotalReviews
    if (entity.minimumManagerReviews !== undefined)
      result['minimum_manager_reviews'] = entity.minimumManagerReviews
    if (entity.minimumPeerReviews !== undefined)
      result['minimum_peer_reviews'] = entity.minimumPeerReviews
  ...
  static toSkillReviewDomain(model: SkillReview): SkillReviewEntity {
    const props: SkillReviewEntityProps = {
      ...
      assignedLevelCode: model.assigned_public_proficiency_code,
  ...
  static toSkillReviewOrm(entity: Partial<SkillReviewEntityProps>): Record<string, unknown> {
    ...
    if (entity.assignedLevelCode !== undefined)
      result['assigned_public_proficiency_code'] = entity.assignedLevelCode
