...
import { buildMemberCandidatesRequest } from '../mappers/request/project-members/member_candidates_request_mapper.js'
...
export default class ListProjectMemberCandidatesController {
  ...
  async handle(ctx: HttpContext) {
    const input = buildMemberCandidatesRequest(ctx.params, ctx.request)
