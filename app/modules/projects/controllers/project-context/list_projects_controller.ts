...
import { buildProjectsListDTO } from '../mappers/request/project-context/project_request_mapper.js'
import { mapProjectsIndexPageProps } from '../mappers/response/project-context/project_response_mapper.js'
...
export default class ListProjectsController {
  ...
  async handle(ctx: HttpContext) {
    ...
    const outcome = await this.queries
      .makeProjectsIndex(actionContextFromHttp(ctx))
      .executeAndWrap(dto)
