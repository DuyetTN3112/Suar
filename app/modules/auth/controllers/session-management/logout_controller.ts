...
import { buildLogoutUserDTO } from '../mappers/request/session-management/auth_request_mapper.js'
import {
  getLogoutRedirectPath,
  mapLoggedOutAuthShare,
  shouldUseInertiaLocation,
} from '../mappers/response/session-management/auth_response_mapper.js'
...
export default class LogoutController {
  ...
  async handle(ctx: HttpContext) {
    ...
    await this.logoutUser.executeAndWrap({
