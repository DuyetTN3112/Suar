...
/**
 * In-process single-flight executor that coalesces concurrent work by key.
 * Callers sharing a key await the same representative operation.
 */
...
/**
 * In-process single-flight executor - default export
 */
const inProcessSingleFlightExecutor = {
  execute,
  isInFlight,
  getInFlightCount,
  clear,
...
export default inProcessSingleFlightExecutor
