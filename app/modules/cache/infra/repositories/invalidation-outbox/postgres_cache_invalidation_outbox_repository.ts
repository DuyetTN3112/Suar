...
import { PostgresCacheInvalidationOutboxStatusReader } from './postgres_cache_invalidation_outbox_status_reader.js'
...
{
  readonly #statusReader = new PostgresCacheInvalidationOutboxStatusReader()
  ...
  async operationalStatus(
    ...
    return this.#statusReader.operationalStatus(now)
  }

  async backlog(): Promise<CacheInvalidationOutboxBacklog> {
    return this.#statusReader.backlog()
  }
