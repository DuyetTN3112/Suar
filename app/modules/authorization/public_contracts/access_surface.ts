...
> = {
  ...
  'can_manage_notification_operations': {
    label: 'Vận hành trung tâm thông báo',
    description: 'Theo dõi, replay và xử lý hàng đợi notification dead-letter.',
    category: 'Operations',
  },
  'can_create_project': {
    label: 'Tạo dự án',
  ...
  'can_approve_application': {
    label: 'Duyệt đề xuất tham gia',
    description: 'Xử lý đề xuất tham gia trên marketplace hoặc task external.',
    category: 'Marketplace',
  },
  ...
  'can_manage_project_resources': {
    label: 'Quản lý nguồn lực dự án',
    description: 'Theo dõi và điều chỉnh nguồn lực của project.',
    category: 'Project',
  },
