...
export interface ApplyTaxonomyMigrationPlanInput {
  planToken: string
  expectedVersion: number
  currentVersion: number
  publishedVersion: number
  items: readonly TaxonomyMigrationItem[]
  completedIds: readonly string[]
  limit: number
}

export function applyTaxonomyMigrationPlan(
  input: ApplyTaxonomyMigrationPlanInput
): TaxonomyMigrationCheckpoint {
  if (
