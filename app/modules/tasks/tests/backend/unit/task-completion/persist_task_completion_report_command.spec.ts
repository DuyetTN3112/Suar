...
test.group('Persist Task Completion Report command', () => {
  ...
  test('persists every Evidence Contract target on each evidence manifest row', async ({
    ...
    const report = {
      ...
      actualOwnership: 'primary_owner' as const,
      actualAutonomy: 'independent' as const,
      ...
      evidence: [
        {
          ...
          deliverableIds: deliverables,
          ownerUserId: base.report.reportedBy,
          contributorUserIds: [base.report.reportedBy],
      ...
      contributorClaims: [
        {
          id: crypto.randomUUID(),
          contributorUserId: base.report.reportedBy,
