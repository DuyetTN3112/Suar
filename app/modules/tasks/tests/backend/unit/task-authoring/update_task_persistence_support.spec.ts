...
test.group('Update task persistence support', () => {
  test('persists an authoring-only version without a fake Task-row update and audits metadata only', async ({
    ...
    const lifecycle: TaskExternalDependencies['lifecycle'] = Object.assign(
      Object.create(taskExternalDeps.lifecycle as object) as TaskExternalDependencies['lifecycle'],
      {
    ...
    const assignments: TaskExternalDependencies['assignments'] = Object.assign(
      Object.create(taskExternalDeps.assignments as object) as TaskExternalDependencies['assignments'],
      {
