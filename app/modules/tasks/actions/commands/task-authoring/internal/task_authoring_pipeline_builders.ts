...
export const EMPTY_WORK_CONTRACT: TaskWorkContractV1 = Object.freeze({
  action: '',
  object: '',
  problemStatement: '',
  desiredOutcome: '',
...
export const EMPTY_OPERATIONAL_EVIDENCE_CONTRACT: TaskEvidenceContractV1 = Object.freeze({
...
export const EMPTY_EVIDENCE_ENABLED_CONTRACT: TaskEvidenceContractV1 = Object.freeze({
  ...EMPTY_OPERATIONAL_EVIDENCE_CONTRACT,
  mode: 'evidence_enabled',
})

export function targetPrivacy(taskVisibility: string): TvaPrivacyClassification {
...
export function buildEffectiveEvidence(dto: TaskAuthoringSubject): TaskEvidenceContractV1 {
  const defaults =
...
export function buildResolutionLayers(input: {
  dto: TaskAuthoringSubject
  specificationVersionId: string
...
export function readinessInputAsJson(input: {
...
export function assertPublishReady(dto: TaskAuthoringSubject, readiness: TaskReadinessResultV1): void {
  const ready =
    dto.authoring.mode === 'evidence_enabled'
