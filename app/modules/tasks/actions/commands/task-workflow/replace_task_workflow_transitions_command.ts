 ...
 */
export default class ReplaceTaskWorkflowTransitionsCommand extends BaseCommand<
  UpdateWorkflowDTO,
...
> {
  ...
  async handle(dto: UpdateWorkflowDTO): Promise<TaskWorkflowTransitionRecord[]> {
      ...
      await auditPublicApi.log(
        {
          ...
          entity_id: dto.project_id ?? dto.organization_id,
