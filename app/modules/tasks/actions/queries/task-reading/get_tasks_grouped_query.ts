 ...
 */
type GetTasksGroupedInput = { organizationId: string }
type GetTasksGroupedOutput = Record<string, TaskDetailRecord[]>

export default class GetTasksGroupedQuery extends BaseQuery<
  GetTasksGroupedInput,
  GetTasksGroupedOutput
> {
  constructor(
  ...
  override executeAndWrap(
    input: GetTasksGroupedInput
  ): ReturnType<BaseQuery<GetTasksGroupedInput, GetTasksGroupedOutput>['executeAndWrap']>
  override executeAndWrap(
    organizationId: string
  ): ReturnType<BaseQuery<GetTasksGroupedInput, GetTasksGroupedOutput>['executeAndWrap']>
  override executeAndWrap(
    inputOrOrganizationId: GetTasksGroupedInput | string
  ): ReturnType<BaseQuery<GetTasksGroupedInput, GetTasksGroupedOutput>['executeAndWrap']> {
  ...
  async execute(organizationId: string): Promise<GetTasksGroupedOutput> {
    return this.handle({ organizationId })
  }

  async handle({ organizationId }: GetTasksGroupedInput): Promise<GetTasksGroupedOutput> {
