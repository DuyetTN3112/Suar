...
function buildSubmissionDTO(ctx: HttpContext, submit: boolean): SubmitTaskSubmissionDTO {
  ...
  return {
    ...
    implementation_notes:
      (readSubmissionValue(body, 'implementationNotes', 'implementation_notes') as string | null) ??
      null,
    known_limitations:
      (readSubmissionValue(body, 'knownLimitations', 'known_limitations') as string | null) ?? null,
    test_notes: (readSubmissionValue(body, 'testNotes', 'test_notes') as string | null) ?? null,
    demo_url: (readSubmissionValue(body, 'demoUrl', 'demo_url') as string | null) ?? null,
    repository_url:
      (readSubmissionValue(body, 'repositoryUrl', 'repository_url') as string | null) ?? null,
    pull_request_url:
      (readSubmissionValue(body, 'pullRequestUrl', 'pull_request_url') as string | null) ?? null,
    submit,
