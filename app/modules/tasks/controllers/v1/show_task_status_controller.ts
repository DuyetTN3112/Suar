...
import { mapTaskStatusDefinitionApiBody } from '../mappers/response/task-status/task_status_response_mapper.js'
...
export default class ShowTaskStatusController {
  ...
  async handle(ctx: HttpContext) {
    ...
    const status = await this.getStatus
      .executeAndWrap(ctx.params['taskStatusId'] as string, organizationId)
