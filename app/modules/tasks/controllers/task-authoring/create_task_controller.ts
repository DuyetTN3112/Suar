...
import { buildCreateTaskDTO } from '../mappers/request/task-reading/task_request_mapper.js'
import { mapTaskCreateApiBody } from '../mappers/response/task-reading/task_response_mapper.js'
...
export default class CreateTaskController {
  ...
  async handle(ctx: HttpContext) {
    ...
    try {
      ...
      task = await this.lifecycleCommands
