...
import TaskRequirementVersion from '#modules/tasks/infra/models/task-requirements/task_requirement_version'
import TaskRequirementVersionItem from '#modules/tasks/infra/models/task-requirements/task_requirement_version_item'

export type { TaskRequirementVersion, TaskRequirementVersionItem, TaskRequiredSkill }
export type { RequirementVersionReason } from '#modules/tasks/infra/models/task-requirements/task_requirement_version'
