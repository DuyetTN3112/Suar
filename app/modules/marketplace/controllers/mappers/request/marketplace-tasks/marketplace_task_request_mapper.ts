...
function toAcceptingApplications(
  value: unknown
): MarketplaceTaskListingInput['accepting_applications'] {
  return value === 'open' || value === 'closed' ? value : null
}

function toSkillMatch(value: unknown): MarketplaceTaskListingInput['skill_match'] {
...
export function buildGetMarketplaceTasksDTO(
  ...
  return {
    ...
    skill_match: toSkillMatch(readAliasedInput(request, 'skillMatch', 'skill_match', 'any')),
    ...
    sort_order: toPublicTaskSortOrder(readAliasedInput(request, 'sortOrder', 'sort_order', 'desc')),
  }
}
