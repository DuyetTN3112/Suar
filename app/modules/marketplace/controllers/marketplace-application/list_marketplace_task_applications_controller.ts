...
import { buildGetMarketplaceTaskApplicationsDTO } from '../mappers/request/marketplace-application/marketplace_application_request_mapper.js'
import { mapMarketplaceTaskApplicationsPageProps } from '../mappers/response/marketplace-application/marketplace_application_response_mapper.js'
...
export default class ListMarketplaceTaskApplicationsController {
  ...
  async handle(ctx: HttpContext) {
    ...
    const result = await query.handle(dto).then((outcome) => outcome.getValue())
