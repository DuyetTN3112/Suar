...
import type { DomainEventOutboxAdministrationAuditWriter } from '#modules/events/actions/dtos/domain-event-outbox-administration/domain_event_outbox_administration'
import type { DomainEventOutboxAdministrationRepository,
  DomainEventOutboxAdministrationEvidenceGenerator,
  DomainEventOutboxAdministrationTransactionExecutor } from '#modules/events/actions/ports/outbound/domain-event-outbox-administration/domain_event_outbox_administration_ports'
...
import type { DomainEventOutboxReplayInput } from '#modules/events/domain/domain-event-outbox-administration/domain_event_outbox_administration'
import {
