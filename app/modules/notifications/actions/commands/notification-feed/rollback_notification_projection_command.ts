...
export interface RollbackNotificationProjectionCommandInput {
  actorId: string
  reason: string
...
export class RollbackNotificationProjectionCommand extends BaseCommand<
  RollbackNotificationProjectionCommandInput,
  NotificationProjectionRollbackResult
> {
  ...
  override async execute(
    input: RollbackNotificationProjectionCommandInput
