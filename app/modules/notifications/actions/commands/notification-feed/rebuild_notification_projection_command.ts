...
export interface RebuildNotificationProjectionCommandInput {
  actorId: string
  reason: string
  dryRun: boolean
  batchSize?: number
...
export class RebuildNotificationProjectionCommand extends BaseCommand<
  RebuildNotificationProjectionCommandInput,
  NotificationProjectionRebuildResult
> {
  ...
  override async execute(
    input: RebuildNotificationProjectionCommandInput
