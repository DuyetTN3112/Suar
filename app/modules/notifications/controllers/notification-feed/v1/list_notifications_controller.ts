...
import { buildListNotificationsV1Request } from '#modules/notifications/controllers/mappers/request/notification-feed/list_notifications_request_mapper'
...
export default class ListNotificationsController {
  ...
  async handle(ctx: HttpContext) {
    ...
    const mapped = buildListNotificationsV1Request(request)
