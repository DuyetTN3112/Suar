...
export async function seedProjects(
  ...
  for (const [key, spec] of Object.entries(specs) as [
    ...
    const payload = {
      ...
      name: spec.name,
      description: `${spec.name} coordinates linked delivery work, review evidence, staffing, and sprint governance for its organization.`,
      ...
      allow_external_contributors: ['orgA', 'orgD', 'orgE'].includes(spec.organization),
