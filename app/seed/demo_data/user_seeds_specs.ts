...
export const SEED_USERS_SPECS: Record<UserKey, UserSpec> = {
  owner: {
    ...
    auth_method: 'github',
    bio: 'Account test chính: owner org A, member org B, có working/done/disputed tasks, marketplace applications và profile proof.',
    is_freelancer: true,
    rating: 4.7,
    completedTasks: 4,
    headline: 'Main test account for owner/member/freelancer/profile flows',
