<script lang="ts">
  ...
  import DropdownMenuLabel from '@/apps/org/shared/ui/dropdown_menu_label.svelte'
  import DropdownMenuSeparator from '@/apps/org/shared/ui/dropdown_menu_separator.svelte'
  import DropdownMenuTrigger from '@/apps/org/shared/ui/dropdown_menu_trigger.svelte'
  import { FRONTEND_NOTIFICATION_TYPES } from '@/apps/org/modules/notifications/constants/notifications'
  import { dateFnsLocale, dateTimePattern } from '@/apps/org/shared/lib/date_locale'
  import { postUiTelemetry } from '@/apps/org/shared/lib/ui_telemetry'
  import { useNotifications } from '@/apps/org/modules/notifications/stores/notifications.svelte'
  import {
