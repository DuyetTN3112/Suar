<script lang="ts">
  ...
  import NotificationDropdown from '@/apps/org/shared/components/layout/notification_dropdown.svelte'
  import { FRONTEND_ROUTES, THEME_OPTIONS } from '@/apps/org/shared/constants'
...
<header class="sticky top-0 z-20 border-b border-border bg-card/95 text-card-foreground backdrop-blur-md">
  <div class="flex items-center gap-2 px-4 py-3 sm:gap-4 sm:px-6">
    ...
    <form class="mr-2 hidden min-w-0 flex-1 max-w-xl md:block" onsubmit={handleSearchSubmit}>
