<script lang="ts">
  ...
  import { APPLICATION_STATUSES, APPLICATION_STATUS_BADGE_VARIANTS, FILTER_VALUES, getTaskApplicationProcessRoute, getTaskApplicationsRoute, type ApplicationFilterValue, type ApplicationStatus } from '@/apps/org/shared/constants'
