<script lang="ts">
  ...
  import type { TaskDetail } from '@/apps/org/modules/tasks/types/index.svelte.ts'

  import TaskListRow from '@/apps/org/modules/tasks/components/task_list/task_list_row.svelte'
