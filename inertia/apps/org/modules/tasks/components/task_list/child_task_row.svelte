<script lang="ts">
  ...
  import TaskDetailModal from '@/apps/org/modules/tasks/components/modals/task_detail_modal.svelte'

  import AssigneeCell from '@/apps/org/modules/tasks/components/task_list/cells/child/assignee_cell.svelte'
  import DateCell from '@/apps/org/modules/tasks/components/task_list/cells/child/date_cell.svelte'
  import DueDateCell from '@/apps/org/modules/tasks/components/task_list/cells/child/due_date_cell.svelte'
  import LabelCell from '@/apps/org/modules/tasks/components/task_list/cells/child/label_cell.svelte'
  import PriorityCell from '@/apps/org/modules/tasks/components/task_list/cells/child/priority_cell.svelte'
  import StatusCell from '@/apps/org/modules/tasks/components/task_list/cells/child/status_cell.svelte'
  import TaskItemDeleteButton from '@/apps/org/modules/tasks/components/task_list/task_item_delete_button.svelte'


  interface Props {
    childTask: TaskDetail
