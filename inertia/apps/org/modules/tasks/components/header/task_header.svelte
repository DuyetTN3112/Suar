<script lang="ts">
  ...
  import DisplayProperties from '@/apps/org/modules/tasks/components/header/display_properties.svelte'
  import TaskFiltersBar from '@/apps/org/modules/tasks/components/header/task_filters_bar.svelte'
