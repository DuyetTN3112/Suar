import { adminNavigationSections } from '@/apps/user/shared/components/navigation/admin_sections'
...
import { filterMainNavigationByRole, mapNavGroup } from '@/apps/user/shared/components/navigation_helpers'
