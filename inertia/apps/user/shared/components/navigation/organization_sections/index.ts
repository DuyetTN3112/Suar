...
import { organizationSprintsSection } from '@/apps/user/shared/components/navigation/organization_sections/sprints'
import { organizationTasksSection } from '@/apps/user/shared/components/navigation/organization_sections/tasks'
