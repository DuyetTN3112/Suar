...
export interface TaskResolvedBriefProjection {
  ...
  resolvedContract?: {
    ...
    evidence?: {
      ...
      verifierPolicy?: {
        reviewerIds?: string[]
        reviewerRoleCodes?: string[]
        minimumReviewers?: number
        disallowSelfReview?: boolean
      }
      reviewerVisibility?: 'project' | 'internal' | 'external' | 'all'
      capabilities?: Array<{
        id: string
        capabilityId: string
...
export interface TaskDetail {
  ...
  /** Immutable Project-domain context captured when this Task was created. */
