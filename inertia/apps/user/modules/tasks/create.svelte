<script lang="ts">
  ...
  import { getTaskContractPreset, mergeTaskContractPreset } from '@/apps/user/modules/tasks/lib/rules/task_contract_presets'
  ...
  import TaskReadinessCard from '@/apps/user/modules/tasks/components/detail/task_readiness_card.svelte'
