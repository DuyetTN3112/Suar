<script lang="ts">
  ...
  import TaskDetailModal from '@/apps/user/modules/tasks/components/modals/task_detail_modal.svelte'

  import AssigneeCell from '@/apps/user/modules/tasks/components/task_list/cells/child/assignee_cell.svelte'
  import DateCell from '@/apps/user/modules/tasks/components/task_list/cells/child/date_cell.svelte'
  import DueDateCell from '@/apps/user/modules/tasks/components/task_list/cells/child/due_date_cell.svelte'
  import LabelCell from '@/apps/user/modules/tasks/components/task_list/cells/child/label_cell.svelte'
  import PriorityCell from '@/apps/user/modules/tasks/components/task_list/cells/child/priority_cell.svelte'
  import StatusCell from '@/apps/user/modules/tasks/components/task_list/cells/child/status_cell.svelte'
