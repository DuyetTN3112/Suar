<script lang="ts">
  ...
  import SlicePanel from '@/apps/user/modules/tasks/components/status_board_panel.svelte'
  import type { SliceItem, SliceMetadata } from '@/apps/user/modules/tasks/types/status_board_types'
...
<AppLayout title={t('task.status_board.title', {}, 'Task status board')}>
