<script lang="ts">
  ...
  import { APPLICATION_FILTER_OPTIONS, APPLICATION_STATUS_BADGE_VARIANTS, APPLICATION_STATUS_LABELS, FILTER_VALUES, FRONTEND_ROUTES, getApplicationWithdrawRoute, getTaskDetailRoute, type ApplicationFilterValue, type ApplicationStatus } from '@/apps/user/shared/constants'
