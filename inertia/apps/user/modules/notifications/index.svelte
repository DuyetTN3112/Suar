<script lang="ts">
  ...
  } from '@/apps/user/modules/notifications/constants/notifications'
  ...
  const { notifications, pagination, unread_count: initialUnreadCount, filters, shellMode = 'app' }: Props = $props()
