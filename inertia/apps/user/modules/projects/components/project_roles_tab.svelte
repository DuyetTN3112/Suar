<script lang="ts">
  ...
  import ProficiencyLevelBadge from '@/apps/user/modules/profile/components/proficiency_level_badge.svelte'
  ...
  import { inferTaskTypeFromRoleCode } from '@/apps/user/modules/tasks/lib/rules/task_contract_presets'
