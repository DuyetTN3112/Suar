...
export const PROFILE_CATEGORY_ORDER = ['technology', 'engineering', 'soft_skill', 'delivery'] as const
export type ProfileCategoryCode = (typeof PROFILE_CATEGORY_ORDER)[number]
