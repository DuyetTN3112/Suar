...
vi.mock('@/apps/user/modules/tasks/components/detail/task_detail_metadata_sidebar.svelte', () => ({
  default: EmptyStub,
}))

vi.mock('@/apps/user/modules/tasks/components/detail/task_execution_brief.svelte', () => ({
  default: EmptyStub,
}))
...
vi.mock('@/apps/user/shared/ui/dialog.svelte', () => ({
  default: LayoutStub,
}))

vi.mock('@/apps/user/shared/ui/dialog_content.svelte', () => ({
  default: LayoutStub,
}))
