<script lang="ts">
  ...
  import { adminNavigation } from '@/apps/admin/shared/components/navigation.svelte'
...
<ControlSidebar
  ...
  ticketTitle="Admin mode"
  ticketText="Monitor IBSC quality signals"
  workspaceLabel="System workspace"
  logo="♜"
/>
