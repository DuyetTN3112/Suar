<script lang="ts">
  ...
  import NotificationDropdown from '@/apps/admin/shared/components/layout/notification_dropdown.svelte'
  import { FRONTEND_ROUTES, THEME_OPTIONS } from '@/apps/admin/shared/constants'
