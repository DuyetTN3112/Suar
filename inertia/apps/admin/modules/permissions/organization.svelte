...
<svelte:head>
  <title>{t('task.admin_permissions.organization_roles', {}, 'Organization roles')}</title>
</svelte:head>

<div class="space-y-6">
  <div>
    <h1 class="text-4xl font-bold tracking-tight">{t('task.admin_permissions.organization_roles', {}, 'Organization roles')}</h1>
  </div>
  ...
  <div class="mt-4 space-y-4">
    <Card>
      <CardHeader>
        <CardTitle>{t('task.admin_permissions.organization_role_list', {}, 'Organization role list')}</CardTitle>
      </CardHeader>
    ...
    <Card>
      <CardHeader>
        <CardTitle>{t('task.admin_permissions.organization_permission_catalog', {}, 'Organization permission catalog')}</CardTitle>
      </CardHeader>
      <CardContent class="space-y-4">
