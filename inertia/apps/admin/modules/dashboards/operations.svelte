<script lang="ts">
  ...
  const pageTitle = $derived(t('task.admin_dashboard.operations.page_title', {}, 'Admin Dashboard - Operations'))
...
<div class="space-y-6">
  <div>
    <p class="font-medium uppercase tracking-wider text-xs text-muted-foreground">{t('task.admin_dashboard.operations.eyebrow', {}, 'Admin / Operations Dashboard')}</p>
    <h1 class="text-4xl font-bold tracking-tight">{t('task.admin_dashboard.operations.title', {}, 'Operations dashboard')}</h1>
  </div>
