<!--
  AlertDialogAction Component - Svelte 5
-->

<script lang="ts">
  import { cn } from '$lib/utils-svelte'
  import { AlertDialog as AlertDialogPrimitive, type AlertDialogActionProps } from 'bits-ui'
