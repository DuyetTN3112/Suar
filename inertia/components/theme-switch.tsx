          ...
          <div>
            <DropdownMenu modal={false}>
              <DropdownMenuTrigger asChild>
                <Button variant='ghost' size='icon' className='scale-95 rounded-full hover:bg-accent hover:text-accent-foreground'>
              ...
              <DropdownMenuContent align='end' className="min-w-[180px]">
                ...
                <DropdownMenuItem onClick={() => setTheme('system')} className="cursor-pointer">
                  ...
                  <Check
                    size={14}
                    className={cn('ml-auto', theme !== 'system' && 'invisible')}
                  />
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
