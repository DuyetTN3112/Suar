...
// Browser journeys exercise the new verified projection and the legacy fallback
// in the same run; make the rollout mode explicit instead of inheriting a
// production-safe legacy-only default.
process.env['TVA_ACCOMPLISHMENT_CUTOVER'] ??= 'dual_read'
